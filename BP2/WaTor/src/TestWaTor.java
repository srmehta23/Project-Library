...
public class TestWaTor {
	...
	public static void main(String[] args) {
		...
		// test code for fishPositions would be similar to test code for
		// unoccupiedPositions
     ...
     *      is the column.
     */
	//This method declares a fish array which has just one fish and a shark array having no shark and checks for the unoccupied positions around a given row and column
	private static void testUnoccupiedPositions() {
		...
		ArrayList<int[]> positions = WaTor.unoccupiedPositions(fish, sharks, 1, 1); //calls the method unoccupied positions to return an array containing the x and y coordinates of unoccupied positions.
		ArrayList<int[]> expected = new ArrayList<>();
		expected.add(new int[] { 0, 1 });
		expected.add(new int[] { 2, 1 });
		expected.add(new int[] { 1, 0 });
		expected.add(new int[] { 1, 2 });
		if (!matchingArrayLists(expected, positions)) { // this checks whether the returned array by the method is same as the expected or not.
			error = true;
	...
	/**
	 * This runs some tests on the fishPositions method. 1. TODO describe each test
	 * in your own words. 2.
	 */
	private static void testFishPositions() {
		...
		ArrayList<int[]> positions = WaTor.fishPositions(fish,1,1); //calls the method unoccupied positions to return an array containing the x and y coordinates of unoccupied positions.
		ArrayList<int[]> expected = new ArrayList<>();
		expected.add(new int[] { 0, 1 });
		expected.add(new int[] { 2, 1 });
		expected.add(new int[] { 1, 0 });
	...
	/**
	 * This runs some tests on the chooseMove method. 1. TODO describe each test in
	 * your own words. 2.
	 */
	...
	/**
	 * This runs some tests on the clearMoves method. 1. TODO describe each test in
	 * your own words.
	 */
	/*
	 * In this method(testClearMoves). Firstly, we declare a 4X9 array and assign
	 * every element in the array to be true and then on calling the method
	 * clearMoves, it changes every single element in the given array to false.
	 * Then, the if condition with the help of a for loop, checks whether every
	 * element in the array is false or not. If not, then method testClearMoves
	...
	/**
	 * This runs some tests on the emptyArray method. 1. TODO describe each test in
	 * your own words.
	 */
	/*
	 * This method(testEmptyArray) is a check for the method emptyArray. The test
	 * method firstly creates an array and fills it up with elements such that it is
	 * not empty and then calls the method emptyArray to empty the whole array. With
	 * the help of if condition it checks whethere the whole array is empty or not.
	 * IF NOT, it prints "testEmptyArray failed."Otherwise, it prints "testEmptyArray passed".
	 */
	...
	/**
	 * This runs some tests on the countFish method. 1. TODO describe each test in
	 * your own words. 2.
	 */
	/*
	 * This test method checks for the number of fish or the number of sharks depending as per the array passed.
	 * If the output of the method(countCreatures) does not match with the pre-determined output of the test condition .
	 * Then, the method fails and prints ("testCountCreatures failed"). Otherwise, it prints "testCountCreatures passed".
	 */
